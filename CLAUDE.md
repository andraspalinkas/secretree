...
Private git in Go: encrypted repositories on any host with PRs, reviews and CI intact. Module path github.com/andraspalinkas/secretree; public repo on GitHub, website source on GitLab (andras.palinkas/secretree-site) deployed by Vercel to https://secretree-site.vercel.app. Docs first: `docs/vault-format.md` is the
